...
import deployedArbiterConfig from './ArbiterConfig.deployed.json';
...
module.exports = {
  Cases : {
    ...
    params: [deployedArbiterConfig['txReceipt']['contractAddress']],
    web3
  },
  ArbiterConfig : {
    name: "ArbiterConfig", // name of the primary contract file (without .sol), e.g. TokenExchange
    directory: __dirname, // path to directory containing src directory with sol files
    sendObject: {
      from: web3.eth.accounts[0],
      gas: 4712388,
